...
describe('Transaction', () => {
    ...
    describe('input', () => {
        ...
        it('has a `timestamp in an `input`', () => {
            expect(transaction.input).toHaveProperty('timestamp');
        });

        it('sets the amount to senderWallet balance', () => {
            expect(transaction.input.amount).toBeLessThanOrEqual(senderWallet.balance);
        });
    ...
    describe('rewardTransaction()', () => {
        ...
        it('create ones transaction for the miner with the `MINERS_REWARD`', () => {
